...
(1..5).each { |e|  Content.create plot: "Rambo#{e} is a nice film", title: "Rambo#{e}", year: YEAR_OPTION.sample, price: PRICE_OPTION.sample }
(1..5).each { |e|  Movie.create plot: "Rocki#{e} is a nice film", title: "Rocki#{e}", year: YEAR_OPTION.sample, price: PRICE_OPTION.sample }
(1..rand(10)).each do |e|
